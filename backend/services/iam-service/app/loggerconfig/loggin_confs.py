...
def configure_logger():
    os.makedirs("FitPlan_IAM_logs", exist_ok=True)
    ...
    logger.add("FitPlan_IAM_logs/iam_service_info.log", level="INFO", **json_logging_format)
    logger.add("FitPlan_IAM_logs/iam_service_error.log", level="ERROR", **json_logging_format)
