...
from app.mainservices import user_mainservice

user_chat_router = APIRouter()


# @user_chat_router.websocket(
#     "/ws/chat",
# )
# async def user_chat_websocket_endpoint(websocket: WebSocket,
#                                        current_user: Annotated[TokenDataSchema, Depends(get_current_user)],
#                                        user_service: Annotated[UserMainService, Depends()]
#                                        ):
#     return await user_service.user_chat_websocket(websocket, current_user.id)
