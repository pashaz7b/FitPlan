...
class MediaService:
    ...
    async def create_media(self, file: UploadFile, user_id: int) -> MediaSchema:
    ...
    async def __get_media_model(self, media_id: ObjectId, user_id: int) -> Tuple[MediaGridFSModel, AsyncIOMotorGridOut]:
    ...
    async def get_media(
        self, media_id: ObjectId, user_id: int
    ...
    async def get_media_data(self, media_id: str, user_id: int) -> bytes:
