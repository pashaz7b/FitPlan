...
export default function Coaches_card({
  nameSurname,
  username,
  phoneNumber,
  email,
        ...
        <div className="max-md:w-[95%] max-md:gap-4 max-md:text-center max-md:overflow-y-auto max-md:scrollbar-thin max-md:scrollbar-thumb-superRed max-md:scrollbar-track-coal max-md:mx-auto w-[70%] py-5 px-2 flex flex-col text-center mx-auto gap-11">
          ...
          <div className="max-md:flex-col max-md:gap-4 w-[35%] flex justify-between mx-auto gap-11">
            <div className="w-full flex justify-between">
              ...
              <p className="text-[20px] font-light">{status}</p>
            </div>
          </div>
          <div className="max-md:flex-col max-md:gap-4 flex justify-between mx-auto gap-11">
            <div className="w-full flex justify-between max-md:flex-col max-md:text-center">
              <p className="font-medium text-[20px] w-[50%] max-md:text-center max-md:mx-auto">درباره مربی:</p>
              <p className="text-[20px] font-light">{about}</p>
            </div>
          </div>
        </div>
      </div>
