...
export default function OTP_comp() {
    ...
    return(
        <form onSubmit={handleOTP} className="top-0 mt-5 w-[35%] md:w-[28%] h-[250px] md:h-[px] border border-white rounded-[10px] bg-coal flex flex-col justify-center align-items-center text-center text-[20px]">
