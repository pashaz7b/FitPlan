    ...
    return(
        <div className="bg-black w-full h-full flex justify-start pr-[400px] gap-[35px] mx-auto font-iranyekan">
              ...
              <div className="flex flex-col items-center bg-coal">
                ...
                />
                <p className="mt-3 text-lg font-semibold text-superRed">آونگ روزبه</p>
                <p className="mt-2 text-lg text-superRed font-light">AAAvng@</p>
              </div>

              {/* Scrollable List Section */}
              <div className="overflow-y-auto max-h-[330px] scrollbar-thin scrollbar-thumb-superRed scrollbar-track-coal" >
                <div className="flex flex-col gap-1 p-2">
                    ...
                    <div className="w-[90%] border-[2px] border-crimsonRed bg-coal text-mintCream text-[20px] flex justify-between rounded-[10px] max-h-[58px] mx-auto mt-3 py-3 px-3 hover:bg-superRed hover:border-superRed transition-all duration-300">
                        <p>مربی</p>
