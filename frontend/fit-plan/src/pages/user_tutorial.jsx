...
export default function User_tutorial() {
  ...
  const movements = [
    {
      name: "ددلیفت",
      image: "/Images/Dead-lift.webp",
      video: "/Videos/Dead-lift.mp4",
    },
    {
      name: "پرس سینه",
    ...
    },
    {
      ...
      video: "/Videos/Squat-with-Barbell.mp4",
    },
    {
      name: "جلوبازو دمبل",
      image: "/Images/Incline-Dumbbell-Curl.jpg",
      video: "/Videos/Incline-Dumbbell-Curl.mp4",
    },
  ];
  ...
  return (
    <div className="max-lg:pr-0 max-lg:justify-center max-lg:text-center max-lg:mx-auto bg-black w-full h-full flex justify-start pr-[400px] gap-[35px] mx-auto font-iranyekan">
      <div className="max-lg:hidden fixed top-[48px] right-[51px] w-[320px] h-[700px] overflow-hidden bg-coal rounded-[15px] shadow-lg font-iranyekan">
        ...
        <a
          href="/user_login"
          className="text-superRed text-[20px] flex justify-center mx-auto mt-5 hover:text-mintCream transition-all duration-300"
        >
          خروج
        </a>
      </div>
      <div className="flex flex-col gap-5 justify-start w-[95%] py-[40px]">
        ...
        <div className="max-md:flex-col max-md:justify-start max-md:gap-3 max-md:text-center max-md:overflow-y-auto border mb-[22px] rounded-[10px] h-[618px] overflow-hidden flex justify-center  pr-[25px] gap-5 pt-[15px] text-mintCream">
          <div className="max-lg:mx-auto max-lg:justify-center max-lg:text-center overflow-y-auto w-full mx-auto gap-6 grid max-sm:grid-cols-1 max-md:grid-cols-2 max-lg:grid-cols-4 grid-cols-4 font-medium max-h-[600px] scrollbar-thin scrollbar-thumb-superRed scrollbar-track-coal">
