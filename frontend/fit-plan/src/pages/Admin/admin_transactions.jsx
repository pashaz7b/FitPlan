...
import Coach_exe_req_card from "../../components/coach_exe_req_card";

export default function Admin_transactions() {
    ...
    <div className="max-lg:pr-0 max-lg:justify-center max-lg:text-center max-lg:mx-auto bg-black w-full h-full flex justify-start pr-[400px] gap-[35px] mx-auto font-iranyekan">
      ...
      <div className="flex flex-col gap-5 justify-start w-[95%] py-[40px]">
        <div className="flex justify-between">
          <h1 className="text-[45px] font-bold text-mintCream">تراکنش‌ها</h1>
        ...
        <div className="max-md:overflow-y-auto mb-[22px] rounded-[10px] h-[618px] overflow-hidden flex flex-col justify-start gap-5 text-mintCream">
          <div className="overflow-x-auto w-full justify-start">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="bg-tableBrightGray text-white font-light">
                  <th className="py-2 text-center text-[25px]">شماره</th>
                  <th className="py-2 text-center text-[25px]">تاریخ</th>
                  <th className="py-2 text-center text-[25px]">از طرف</th>
                  <th className="py-2 text-center text-[25px]">گیرنده</th>
                  <th className="py-2 text-center text-[25px]">بابت</th>
                  <th className="py-2 text-center text-[25px]">مبلغ</th>
                </tr>
              </thead>
              <tbody>
                {data.map((row, index) => (
                  <tr
                    key={index}
                    className={
                      index % 2 === 0 ? "bg-coal" : "bg-tableBrightGray"
                    }
                  >
