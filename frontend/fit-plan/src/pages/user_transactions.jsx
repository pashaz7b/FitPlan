...
export default function User_transactions(){
    ...
    const data = [
        {number: "1", date: "1403/6/23", description: "برنامه ورزشی", cost: "1,000,000"},
        {number: "2", date: "1403/6/23", description: "برنامه ورزشی", cost: "1,000,000"},
        {number: "3", date: "1403/6/23", description: "برنامه ورزشی", cost: "1,000,000"}
    ];
    ...
    return(
        <div className="bg-black w-full h-full flex justify-start pr-[400px] gap-[35px] mx-auto font-iranyekan">
            ...
            <div className="flex flex-col gap-5 justify-start w-[95%] py-[40px]">
                ...
                <div className="mb-[22px] rounded-[10px] h-[618px] overflow-hidden flex justify-start gap-5 text-mintCream">
                  ...
                  <table className="min-w-full border-collapse">
                    ...
                    <tbody>
                      {data.map((row, index) => (
                        ...
                        >
                          <td className="py-4 px-4 text-center text-[17px]">{row.number}</td>
                          <td className="py-4 px-4 text-center text-[17px]">{row.date}</td>
                          <td className="py-4 px-4 text-center text-[17px]">{row.description}</td>
                          <td className="py-4 px-4 text-center text-[17px]">{row.cost}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
